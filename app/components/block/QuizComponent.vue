  ...
  <div class="quiz-component">
    <div v-if="currentStep < questions.length" class="quiz-step">
      ...
      <div class="space-y-3">
        <button
          ...
          :key="option.value"
          class="w-full p-4 text-left border-2 rounded-lg transition font-medium"
          :class="
      ...
      <div class="flex gap-4 mt-8">
        <button
          v-if="currentStep > 0"
          class="flex-1 px-4 py-3 border border-neutral-300 text-neutral-700 font-semibold rounded-lg hover:bg-neutral-50 transition"
          @click="previousStep"
        >
          Zurück
        </button>
        <button
          class="flex-1 px-4 py-3 bg-pink-500 text-white font-semibold rounded-lg hover:bg-pink-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
    ...
    <div v-else class="quiz-result">
      ...
      <div class="space-y-4">
        ...
        <button
          class="w-full px-6 py-3 border border-neutral-300 text-neutral-700 font-bold rounded-lg hover:bg-neutral-50 transition"
          @click="resetQuiz"
        >
          Quiz erneut machen
        </button>
